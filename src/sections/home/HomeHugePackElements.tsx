...
import BadgeStatus from '@yourapp/src/components/badge-status';
import { CustomAvatar, CustomAvatarGroup } from '@yourapp/src/components/custom-avatar';
import { MotionViewport, varFade } from '@yourapp/src/components/animate';

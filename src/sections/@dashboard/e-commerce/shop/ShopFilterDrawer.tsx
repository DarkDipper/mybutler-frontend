...
// config
import { NAV } from '@yourapp/src/config-global';
// components
import Iconify from '@yourapp/src/components/iconify';
import Scrollbar from '@yourapp/src/components/scrollbar';
import { ColorMultiPicker } from '@yourapp/src/components/color-utils';
import { RHFMultiCheckbox, RHFRadioGroup, RHFSlider } from '@yourapp/src/components/hook-form';

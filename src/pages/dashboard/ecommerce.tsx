...
} from '@yourapp/src/sections/@dashboard/general/e-commerce';
import { AppWelcome } from '@yourapp/src/sections/@dashboard/general/app';
// assets
import { MotivationIllustration } from '@yourapp/src/assets/illustrations';

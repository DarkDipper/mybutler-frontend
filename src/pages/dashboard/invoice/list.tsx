...
// @types
import { IInvoice } from '@yourapp/src/@types/invoice';
// layouts
...
// sections
import InvoiceAnalytic from '@yourapp/src/sections/@dashboard/invoice/InvoiceAnalytic';
import {
  InvoiceTableRow,
  InvoiceTableToolbar,
} from '@yourapp/src/sections/@dashboard/invoice/list';

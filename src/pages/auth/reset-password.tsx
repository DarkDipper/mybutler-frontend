...
// routes
import { PATH_AUTH } from '@yourapp/src/routes/paths';
// layouts
import CompactLayout from '@yourapp/src/layouts/compact';
// components
import Iconify from '@yourapp/src/components/iconify';
// sections
import AuthResetPasswordForm from '@yourapp/src/sections/auth/AuthResetPasswordForm';
// assets
import { PasswordIcon } from '@yourapp/src/assets/icons';
